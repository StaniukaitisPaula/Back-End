...
const listarContatos = function(number) {
    let listaContatosJSON = {}

    let status = false

    contatos["whats-users"].forEach(contatosForEach => {
        if (contatosForEach.number == number) {

            listaContatosJSON.contatos = contatosForEach.contacts
